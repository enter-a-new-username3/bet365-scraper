        ...
        result.append(
            {
                ...
                "ODS": [
                    data[1]["values"][i]["properties"].get("OD", ""),
                    data[2]["values"][i]["properties"].get("OD", ""),
                    data[3]["values"][i]["properties"].get("OD", ""),
                ],
                "ODS_IDS": [
                    data[1]["values"][i]["properties"].get("ID", ""),
                    data[2]["values"][i]["properties"].get("ID", ""),
                    data[3]["values"][i]["properties"].get("ID", ""),
                ],
...
def pretty_print_table(table):
    ...
    for i in range(len(data[0]["values"])):
        table.add_row(
            [
                data[0]["values"][i]["properties"].get("FD", ""),
                f"{parse_odds(data[1]['values'][i]['properties'].get('OD', '')):0.2f}",
                f"{parse_odds(data[2]['values'][i]['properties'].get('OD', '')):0.2f}",
                f"{parse_odds(data[3]['values'][i]['properties'].get('OD', '')):0.2f}",
            ]
        )
